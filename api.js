(function () {
  ...
  function alignInvestigationProcedureToCommitteeDecision(committeeDecision, modelProcedure) {
    ...
    const pairs = [
      ...
      },
      {
        ...
        proc: 'उजुरीमा उल्लेखित विषयमा बुँदागत रुपमा राय/प्रतिक्रिया माग गरी प्राप्त जवाफका आधारमा छानविन गर्ने।'
      }
    ];
  ...
  NVC.Api.analyzeWithGemini = async function (text) {
    try {
      ...
      let catalogHint = '';
      let localLawCandidates = [];
      try {
        if (window.NVC && NVC.Laws) {
          if (typeof NVC.Laws.formatActsForPrompt === 'function') {
            catalogHint = NVC.Laws.formatActsForPrompt(text, 15);
          }
          if (typeof NVC.Laws.suggestFromComplaint === 'function') {
            localLawCandidates = NVC.Laws.suggestFromComplaint(text, 8);
          }
        }
      } catch (e) { /* ignore */ }
...
4. suggestedLaws: यस उजुरीसँग प्रत्यक्ष सम्बन्धित नेपालका विद्यमान ऐन, संहिता वा नियमावलीहरू र तिनका **विशिष्ट दफा (Section) वा नियम (Rule) नम्बरहरू** सहितको Array। प्रत्येक item मा 'name' (ऐनको पूरा नाम), 'section' (दफा वा नियम नम्बर र शीर्षक), र 'description' (उक्त दफाले व्यवस्था गरेको प्रावधानको संक्षिप्त सार) हुनुपर्छ। कम्तीमा २, बढीमा ६ वटा प्रावधान दिनुहोस्।
      ...
      6. investigationProcedure: committeeDecision ले तोकेको कार्यसँग पूर्ण मेल खाने गरी कानुनी तथा प्राविधिक छानविन प्रकृया लेख्नुहोस्। investigationProcedure मा committeeDecision मा नभएका नयाँ दिशा वा विपरीत कार्य नसमावेश गर्नुहोस्।
       उदाहरण: committeeDecision "सम्बद्ध विवरण कागजात सहित राय/प्रतिक्रिया माग गर्ने।" भएमा investigationProcedure अनिवार्य रूपमा सोही मागलाई छानबिनको पहिलो चरण मान्दै लेख्नुहोस्, जस्तै: "सम्बद्ध विवरण कागजात सहित राय/प्रतिक्रिया माग गरी छानविन अघि बढाउने।"
    ...
    नोट: नेपालको विद्यमान ऐन, नियमावली, संहिता तथा कानुनहरूको व्यापक सूची www.lawcommission.gov.np मा उपलब्ध छ। उजुरीसँग प्रत्यक्ष सम्बन्धित ऐन/कानूनका प्रावधानहरू मात्र समावेश गर्नुहोस्। तलको सन्दर्भ सूची उजुरी अनुसार सम्भावित ऐनहरू हो — यही मात्र सीमित होइन, तर यसभन्दा बाहिरका सम्बन्धित ऐन पनि समावेश गर्नुहोस्।
${catalogHint ? `\nउजुरी अनुसार सम्भावित सम्बन्धित ऐनहरू (सन्दर्भ): ${catalogHint}\n` : ''}
उजुरीको विवरण:
${text}`;
      ...
      if (parsed && typeof parsed === 'object') {
        ...
        const aiSuggestedLaws = parsed.suggestedLaws || [];
        result.suggestedLaws = (window.NVC && NVC.Laws && typeof NVC.Laws.mergeSuggestedLaws === 'function')
          ? NVC.Laws.mergeSuggestedLaws(aiSuggestedLaws, localLawCandidates, 6)
          : aiSuggestedLaws;
